   			...
   			<section class="authorInfo">
   				...
   				<article class="author container">
					<div class="row">
						...
						$mainclasses = "col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-0 col-md-5";
						?>

						<div class="col-xs-6 col-xs-offset-3 col-sm-4 col-sm-offset-0 col-md-3 col-md-offset-2">
							<div class="thumbnail">
						...
						<?php else:
						$mainclasses = "col-md-8 col-md-offset-2 col-sm-10 col-xs-offset-1 col-xs-10";
						endif;
						?>
